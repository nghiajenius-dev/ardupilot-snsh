...
#define LL40LS_SIG_COUNT_MAX      0x02
#define LL40LS_ACQ_CONFIG_REG     0x04
#define LL40LS_DISTHIGH_REG       0x0F        /* High byte of distance register, auto increment */
#define LL40LS_COUNT              0x11
#define LL40LS_REF_COUNT_VAL      0x12
#define LL40LS_THRESHOLD_BYPASS   0x1c
...
#define LL40LS_EN_QUICKTERM       0x00        /* Faster measurements at short range */
#define LL40LS_DIS_QUICKTERM      0x08        /* Default mode, balanced performance */
...
static const struct settings_table settings_v3hp[] = {
    { LL40LS_MEASURE_REG, LL40LS_MSRREG_ACQUIRE },
    { LL40LS_SIG_COUNT_MAX, 0x80},
    { LL40LS_ACQ_CONFIG_REG, LL40LS_DIS_QUICKTERM},
    { LL40LS_REF_COUNT_VAL, 0x05},
    { LL40LS_THRESHOLD_BYPASS, 0x00},
};
